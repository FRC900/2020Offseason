...
cap = cv2.VideoCapture(os.path.join(PATH_TO_TEST_IMAGES_DIR, 'finaltest1.mp4'))
...
ret, ori = cap.read()
#print( ori.shape)
vid_writer = cv2.VideoWriter(os.path.join(PATH_TO_TEST_IMAGES_DIR, 'finaltestannotated.mp4'), cv2.VideoWriter_fourcc(*"FMP4"), 30., (ori.shape[1], ori.shape[0]))
